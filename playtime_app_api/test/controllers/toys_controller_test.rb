...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { ageRange: @toy.ageRange, imageUrl: @toy.imageUrl, link: @toy.link, name: @toy.name, price: @toy.price } }, as: :json
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { ageRange: @toy.ageRange, imageUrl: @toy.imageUrl, link: @toy.link, name: @toy.name, price: @toy.price } }, as: :json
    assert_response 200
  end
